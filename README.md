### This portfolio is built on top of another opensource portfolio repository, [developerFolio](https://github.com/saadpasta/developerFolio).The following README sections are from the developerFolio repository.
